...
public class ServletUtilities {
  ...
  /**
   * Metodo de utilidad para generar el codigo html necesario para volver a la pagina inicial de la aplicación. Se incluye en cada
   * pagina HTML o JSP de la aplicación menos en la inicial.
   *
   * @return una cadena con el codigo html para volver al inicio de la web
   */
  ...
  /**
   * Metodo temporal que genera el código necesario para incluir en aquellos ejericicios que no se hayan realizado aun. Tambien
   * incluye un enlace para volver a la pagina inicial.
   *
   * @param titulo El titulo de la pagina (normalmente es un ejercicio)
   * @return una cadena con el html necesario ademas de incluir un enlace para volver a la pagina inicial
   */
  public static String exerciseNotImplemented(String titulo) {
    String html = "<body>\n" + "<h2 style='text-align:center'>" + titulo
  ...
  public static int getIntParameter(HttpServletRequest request,
    ...
    } catch (NumberFormatException nfe) { // mal formato o nulo
