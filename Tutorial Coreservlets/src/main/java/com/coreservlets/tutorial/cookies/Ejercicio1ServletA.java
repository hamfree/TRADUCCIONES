...
@WebServlet(name = "Ej1ServletA", urlPatterns = {"/handlingCookies/pag1"})
public class Ejercicio1ServletA extends HttpServlet {

  private static final long serialVersionUID = 1L;

  public Ejercicio1ServletA() {
    super();
  }
