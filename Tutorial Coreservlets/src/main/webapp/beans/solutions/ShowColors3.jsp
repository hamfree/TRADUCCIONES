...
<html lang="es">
  <head>
    ...
    <title>Muestra Colores (3)</title>
  </head>
  <jsp:useBean id="colorBean3" class="com.coreservlets.tutorial.beans.ColorBean" scope="application" />
  <jsp:setProperty name="colorBean3" property="*" />
  <body>
    <script type="text/javascript">
      document.body.style.backgroundColor = "<jsp:getProperty name="colorBean3" property="backgroundColor"/>";
      document.body.style.color = "<jsp:getProperty name="colorBean3" property="foregroundColor"/>";
    </script>
    <h1>Muestra Colores (3)</h1>
    Blah, blah, blah, blah.
    <p class="inicio">
