...
<html lang="es">
  <head>
    ...
    <title>Muestra Colores (2)</title>
    <link rel="stylesheet" href="../../css/JSP-Styles.css" type="text/css">
  </head>
  <jsp:useBean id="colorBean2" class="com.coreservlets.tutorial.beans.ColorBean" scope="session" />
  <jsp:setProperty name="colorBean2" property="*" />
  <body>
    <script type="text/javascript">
      document.body.style.backgroundColor = "<jsp:getProperty name="colorBean2" property="backgroundColor"/>";
      document.body.style.color = "<jsp:getProperty name="colorBean2" property="foregroundColor"/>";
    </script>
    <h1>Muestra Colores 2</h1>
    Blah, blah, blah, blah.
    <p class="inicio">
