...
<html lang="es">
  <head>
    ...
    <title>Algunos N&uacute;meros Aleatorios</title>
  </head>
  <body>
    <h1>Algunos N&uacute;meros Aleatorios</h1>
    <p>Pulse F5 o Ctrl + R en su navegador para actualizar la p&aacute;gina y
      as&iacute;­ generar nuevos n&uacute;meros aleatorios.</p>
    <ul>
      <li><sample:randomNum />
      <li><sample:randomNum />
      <li><sample:randomNum />
